...
public class TroubleRepairActivity extends BaseActivity {
                ...
                switch (checkedId) {
                    ...
                    case R.id.rb_processing_order:
                        if (null == processingOrderFragment) {
                            ...
                            fragmentTransaction.show(processingOrderFragment);
                        }
                    ...
                    case R.id.rb_finished_order:
                        if (null == finishedOrderFragment) {
                            ...
                            fragmentTransaction.add(R.id.fl_order_list, finishedOrderFragment, "待评价");
                        } else {
    ...
    private void hideFrament(FragmentTransaction fragmentTransaction) {
        ...
        finishedOrderFragment = (FinishedOrderFragment) supportFragmentManager.findFragmentByTag("待评价");
        if (null != allOrderFragment) {
    ...
    public void onClick() {
        IntentUtils.startActivity(this, NewOrderActivity.class);
    }
}
