...
public interface Apis {
    ...
    /**
     * 设备绑定
     *@RequestParam(value = "residentid", required = true) String residentid,
     *@RequestParam(value = "eui64", required = true) String eui64,
     ...
     */
    @FormUrlEncoded
    @POST("user/bind_device.do")
    Observable<BaseResponse> bindDevice(
            @Field("residentid") String residentid,
            @Field("eui64") String eui64,
            @Field("deviceType") String deviceType
    );
