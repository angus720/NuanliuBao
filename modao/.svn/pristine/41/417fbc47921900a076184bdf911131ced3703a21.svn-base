package nuanliu.com.modao.widget.refreshview;
...
import nuanliu.com.modao.widget.refreshview.callback.IHeaderCallBack;
import nuanliu.com.modao.widget.refreshview.listener.OnBottomLoadMoreTime;
import nuanliu.com.modao.widget.refreshview.listener.OnTopRefreshTime;
import nuanliu.com.modao.widget.refreshview.utils.LogUtils;
import nuanliu.com.modao.widget.refreshview.utils.Utils;
    ...
    private void updateFooterHeight(int deltaY) {
        ...
        if (needAddFooterView() || enableRecyclerViewPullUp) {
            if (mEnablePullUpWhenLoadCompleted || !mContentView.hasLoadCompleted()) {
               ...
               /* if (!needAddFooterView() && mContentView.getStatus() != XRefreshViewState.STATE_COMPLETE && autoLoadMore) {
