                ...
                .subscribe(new Subscriber<PayRecordListBean>() {
                    ...
                    public void onNext(PayRecordListBean payRecordListBean) {
                        if (payRecordListBean.getStatus() == 1) {
                            ...
                            if (payRecordListBean.getBody() != null && payRecordListBean.getBody().getList() != null) {
                                for (PayRecordListBean.BodyBean.ListBeanX totalList : payRecordListBean.getBody().getList()) {
                                    ...
                                    if (totalList.getList() != null) {
                                        for (PayRecordListBean.BodyBean.ListBeanX.ListBean listBean : totalList.getList()) {
                                            list.add(new PayRecordItemBean(listBean.getId(), listBean.getCommunityName(), listBean.getAmount(), listBean.getTime(),listBean.getTitle(),
                                                    listBean.getPayMethod(), listBean.getBizId(), listBean.getHouseholder(), listBean.getAddre(), PayRecordListAdapter.BILL_DETAIL));
                                        }
                                    }
                                }
                            }
