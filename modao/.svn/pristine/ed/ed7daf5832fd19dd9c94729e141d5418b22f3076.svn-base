...
public class WXEntryActivity extends BaseActivity implements IWXAPIEventHandler {
    ...
    private String WX_APP_SECRET = "19aece8a4fa0022a977f32e83dd9d8c2";//创建应用后得到的APP_SECRET
...
//                        mPresenter.weixinLogin(code, this);
//                    } else {
//                        mPresenter.weixinLoginConfine(code, this);
//                    }
                }
