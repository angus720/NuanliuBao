package nuanliu.com.modao.widget.convenientbanner.adapter;
...
//        Log.d("CBPageAdapter", "realPosition:" + realPosition + "position" + position);
        View view = null;

        view = getView(realPosition, null, container);
