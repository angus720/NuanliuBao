...
import nuanliu.com.modao.utils.SSLSocketFactoryUtils;
...
public class ServiceFactory {
    ...
    private static Apis repairapis;
    ...
    public static Apis getRepairapis() {
        if (repairapis == null) {
            synchronized (ServiceFactory.class) {
                if (repairapis == null) {
                    init(2);
...
//                .addInterceptor(cacheInterceptor)
                ...
                .sslSocketFactory(SSLSocketFactoryUtils.createSSLSocketFactory(App.getContext()), SSLSocketFactoryUtils.createTrustAllManager())
...
//        }
        ...
        if (flag == 1) {
            ...
            repairapis = new Retrofit.Builder()
                    .baseUrl(URLUtils.REPAIR_BASEURL)
                    .client(client)
                    .addCallAdapterFactory(RxJavaCallAdapterFactory.create())//设置回调适配器
                    .addConverterFactory(GsonConverterFactory.create())
                    .build()
