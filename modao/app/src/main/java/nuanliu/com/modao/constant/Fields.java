package nuanliu.com.modao.constant;
...
public class Fields {
    ...
    //付款金额
    public static final String SJJE = "sjje";
    //发票类型
    ...
    //绑定用户item
    public static final String RESIDENT_ITEM = "resident_item";
    //住户id
    ...
    //微信ID
    public static final String WX_ID = "wxc51fd9e03749e053";
    //选择报修地址
    ...
    // 页面数据类型标记
    public static final String PAGEDDATA_FLAG = "pageddata_flag";
    // 行政区
    public static final String DISTRICT = "district";
    // 住户地址
    public static final String RESIDENT_ADDR = "resident_addr";
    // 小区
