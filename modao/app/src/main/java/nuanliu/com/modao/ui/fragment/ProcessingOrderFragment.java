 ...
 */
public class ProcessingOrderFragment extends BaseFragment implements XRefreshView.XRefreshViewListener {
    ...
    private void initData() {
        mMultiplestatusview.setOnRetryClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getOrderListData(2, mCursor, mPagesize, true);
            }
        });
        getOrderListData(2, mCursor, mPagesize, true);
    }
...
//                mMultiplestatusview.showEmpty();
    ...
    public void onLoadMore(boolean isSilence) {
        if (menableLoadmore) {
            ...
            new Handler().postDelayed(new Runnable() {
                public void run() {
                    getOrderListData(2, mCursor, mPagesize, false);
                }
            }, 500);
            mloadmorecount++;
        } else {
